...
# 詳細規範請參考: docs-ai/operations/development/testing/testing-standards.md
```
...
2. **參考 TAFL WCS**: 以 `app/tafl_wcs_ws/src/tafl_wcs/test/` 為範本
3. **遵循規範**: 嚴格遵循本文檔標準
...
- 測試檔案管理: docs-ai/operations/development/testing/test-file-management.md
- TAFL WCS 測試實作: `app/tafl_wcs_ws/`
