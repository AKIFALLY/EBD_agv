...
| **臨時實驗測試** | `~/RosAGV/agents/` | `test_*.py` | AI Agent 實驗、功能驗證、POC | 定期清理 |
...
```bash
# 正確
mv app/my_ws/src/my_package/test/experiment_test.py ~/RosAGV/agents/
```
...
## 🔗 交叉引用
- 臨時測試檔案管理: @docs-ai/operations/development/test-file-management.md
