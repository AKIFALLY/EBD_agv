#!/usr/bin/env python3
"""
測試新的 Simple WCS 實現 (獨立測試，不需要 ROS 2)
"""
...
# Import directly to avoid __init__.py which imports ROS 2 modules
import simple_wcs.flow_loader as flow_loader
import simple_wcs.parallel_flow_executor as executor_module
import simple_wcs.wcs_functions as wcs_module

FlowLoader = flow_loader.FlowLoader
ParallelFlowExecutor = executor_module.ParallelFlowExecutor
WCSFunctions = wcs_module.WCSFunctions
register_functions_to_executor = wcs_module.register_functions_to_executor
...
def main():
    ...
    print("\n在容器內運行:")
    print("  1. 使用 ros2 run:")
    print("     ros2 run simple_wcs simple_wcs_node")
    print("  2. 使用 ros2 launch:")
    print("     ros2 launch simple_wcs simple_wcs_launch.py")
