...
class FlowExecutor:
    ...
    def execute_step(self, step: Dict[str, Any]) -> Any:
        ...
        try:
            if exec_cmd == 'foreach':
                result = self.execute_foreach(step)
            elif exec_cmd == 'parallel':
                result = self.execute_parallel(step)
            else:
                result = self.execute_function(step)
    ...
    def execute_foreach(self, step: Dict[str, Any]) -> List[Any]:
        """
    ...
    def execute_parallel(self, step: Dict[str, Any]) -> List[Any]:
        """
